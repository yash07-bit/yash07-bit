...
<!--
  The snake is generated by .github/workflows/snake.yml into the `output`
  branch. No explicit width here on purpose: the SVG is 880x192, which is
  already about GitHub's content width, and leaving the intrinsic size in
  place means a failed load shows a small box instead of a giant empty one.
-->
<p align="center">
  <picture>
